...
if (mysqli_connect_errno()) {
 ...
 $phone_number = $_POST['phone_number']; $kontakt = $_POST['kontakt']; $adress = $_POST['adress'];

$sql = "INSERT INTO supplier (phone_number, kontakt, adress) VALUES ('$phone_number', '$kontakt', '$adress' )";
